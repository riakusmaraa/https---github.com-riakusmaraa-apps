    ...
    $("#formulir").on("click", function() {
      ...
      Swal.fire({
        ...
        html:
          ...
          "<br><br>" +
          '<p class:"m-auto" style:"font-weight: 300">Seluruh form dikirim ke line @raja_brawijaya, kemudian konfirmasi dengan format Daftar DIVISIPILIHANPERTAMA. Contoh konfirmasi: Daftar PERKAP</p>',
        animation: true
      });
    });
    ...
    $("#formulir").on("click", function() {
      ...
      Swal.fire({
        ...
        html:
          ...
          '"><button type="button" class="prokerbtn form2">Form 2</button></a>' +
          "<br><br>" +
          '<p class:"m-auto" style:"font-weight: 300">Seluruh form dikirim ke line @raja_brawijaya, kemudian konfirmasi dengan format Daftar_DIVISIPILIHANPERTAMA. Contoh konfirmasi: Daftar_PERKAP.</p>',
        animation: true
      });
    });
