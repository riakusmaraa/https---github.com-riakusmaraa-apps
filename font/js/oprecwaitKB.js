  ...
  $("#formulir").on("click", function() {
    ...
    Swal.fire({
      ...
      html:
        ...
        "<br><br>" +
        '<p class:"m-auto" style:"font-weight: 300">Seluruh form diunduh dan dikirim dalam bentuk zip/rar ke email intikb2020@gmail.com dengan format HariScreening_DivisiPilihanPertama_Nama_NIM Contoh : Selasa_PIT_Arief_1951xxxxx</p>',
        animation: true
    });
  });
