      ...
      .done(function() {
        ...
        dafresponse.JADWAL.forEach(data => {
          if (
            ...
            let date = "" + daystartobj + " " + monthstartobj + " 2020";
  ...
  $("#formulir").on("click", function() {
    ...
    Swal.fire({
      ...
      html:
        ...
        "<br><br>" +
        '<p class:"m-auto" style:"font-weight: 300">Setelah mendownload form, diharapkan untuk masuk ke grup divisi pilihan pertama dengan konfirmasi ke line @raja_brawijaya (hanya konfirmasi) dengan format <br> <b>"Daftar(spasi)DIVISIPILIHANPERTAMA"</b> <br> Contoh : Daftar DDM. <br><br>Jika ada pertanyaan lain terkait pendaftaran RAJA bisa menghubungi IG/TWITTER/FB RAJA Brawijaya (untuk sementara line digunakan hanya untuk konfirmasi). </p>',
        animation: true
    });
  });
