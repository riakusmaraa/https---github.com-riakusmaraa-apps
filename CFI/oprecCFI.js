      ...
      $.ajax({
        ...
        .done(function() {
          ...
          if (dafresponse.DAFTAR != null) {
            ...
            $("#guide").text("Apabila ada hal-hal yang kurang dipahami mengenai teknis pendaftaran silahkan menghubungi CP: Rizky Kurniawan (081291112252) atau Dzikri  (081932362303)");
    ...
    $("#formulir").on("click", function() {
      ...
      Swal.fire({
        ...
        html:
          ...
          "<br><br>" +
          '<p class:"m-auto" style:"font-weight: 300">Seluruh form dikirim ke email rizkyk241@gmail.com dengan format Namalengkap_Divisipilihanpertama</p>',
        animation: true
      });
    });
