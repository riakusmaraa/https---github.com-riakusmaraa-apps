$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (dafresponse.BIODATA.AGAMA == null) {
          ...
          // $("#infogrup").css("display", "none");
          $("#linkPengumpulan").css("display", "none");
      ...
      .done(function() {
        ...
        if (dafresponse.DAFTAR != null) {
          ...
          // $("#infogrup").append(
          //   '<img src="../img/3Proker/icon/IKON PENGUMUMAN.svg" alt="" /><button type="button" class="btnactive">LINK GROUP</button>'
          // );
          $("#linkPengumpulan").append(
            '<img src="../img/3Proker/icon/IKON PRINT.svg" alt="" /><button type="button" class="btnactive">LINK PENGUMPULAN</button>'
          );
  ...
  $("#formulir").on("click", function() {
    ...
    let url3 = `https://line.me/R/ti/g/RphuJaQ1QZ`;
    Swal.fire({
  ...
  //   // let url1 = `https://em.ub.ac.id/apps/exportpdf/form1.php?id=${idParam}&&key=${reversed}`;
  //   // let url2 = `https://em.ub.ac.id/apps/exportpdf/form2.php?id=${idParam}&&key=${reversed}`;
  //   let url3 = `https://line.me/R/ti/g/k61niD3jZP`;
  //   Swal.fire({
  //     title: "Link Group",
  //     html:
  //     "<br><br>" +'<p class:"m-auto" style:"font-weight: 300">Silahkan bergabung pada grup dengan mengklik tautan berikut <a style="color: #007bff;" href="' +
	// 			url3 +
	// 			'" target="_blank">https://line.me/R/ti/g/k61niD3jZP</a></p>',
  //     animation: true
  //   });
  // });
  
  $("#linkPengumpulan").on("click", function() {
    nim = window.btoa("apps" + nim);
    let reversed = "";
    for (var i = nim.length - 1; i >= 0; i--) {
      reversed += nim[i];
    ...
    // let url1 = `https://em.ub.ac.id/apps/exportpdf/form1.php?id=${idParam}&&key=${reversed}`;
    // let url2 = `https://em.ub.ac.id/apps/exportpdf/form2.php?id=${idParam}&&key=${reversed}`;
    let url3 = `https://em.ub.ac.id/to/PengembalianFormStaffMuda`;
    Swal.fire({
      title: "Link Pengumpulan",
      html:
      "<br><br>" +'<p class:"m-auto" style:"font-weight: 300">Silahkan mengumpulkan form 1, form 2, surat pernyataan, motivation letter dan bukti upload twibbon pada link berikut <a style="color: #007bff;" href="' +
				url3 +
