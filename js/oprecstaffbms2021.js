$(document).ready(function () {
		...
		$.ajax({
			...
			success: function (response) {
				...
				if (dafresponse.BIODATA.AGAMA == null) {
					...
					$("#guide").text("Silahkan mengisi pilihan untuk mendaftarkan diri");
				}
			},
		})
			.done(function () {
	...
	$("#formulir").on("click", function () {
		...
		let url3 = `https://drive.google.com/file/d/1PFq8j87_5K7etR00qBp_Gx7r7LguMm_G/view?usp=sharing`;
		let url4 =
			"https://drive.google.com/file/d/1hbiFhDJO8sXczprRPbZ28DU1s1wd2Wv-/view?usp=sharing";
		Swal.fire({
			...
			html:
				...
				"<br><br>" +
				'<p class:"m-auto" style:"font-weight: 300">Silahkan kirim form yang telah didownload ke alamat email divisi pilihan pertama dengan format “Pilihan Divisi 1_Nama_NIM”</p>' +
				'<p class:"m-auto" style:"font-weight: 300">Contoh: Acara_Dimas_205050400111055</p>' +
				'<p class:"m-auto" style:"font-weight: 300">Untuk alamat email divisi dapat dilihat <a style="color: #007bff;" href="' +
				url4 +
				'" target="_blank">disini</a>' +
				'<p class:"m-auto" style:"font-weight: 300">Silahkan bergabung pada grup menggunakan tautan berikut <a style="color: #007bff;" href="' +
				url3 +
