$(document).ready(function() {
      ...
      .done(function() {
        ...
        dafresponse.JADWAL.forEach(data => {
          if (
            ...
            let date = "" + daystartobj + " " + monthstartobj + " 2022";
  ...
  $("#infogrup").on("click", function() {
    ...
    // let url1 = `https://em.ub.ac.id/apps/exportpdf/form1.php?id=${idParam}&&key=${reversed}`;
    // let url2 = `https://em.ub.ac.id/apps/exportpdf/form2.php?id=${idParam}&&key=${reversed}`;
    let url = `http://line.me/ti/g/IEjAyqhdtd`;
    // let penugasan = `https://line.me/R/ti/g/n0dv1JkYS7`;
    // let humas = `https://line.me/R/ti/g/VzJ250n5iF`;
    // let acara = `https://line.me/R/ti/g/3fzxR3WGiJ`;
    // let ddm = `https://line.me/R/ti/g/9seytAkgpl`;
    // let sek = `https://line.me/R/ti/g/hlu4sEF1ye`;
    // let pit = `https://line.me/R/ti/g/vwhzhMFgtZ`;
    // let spv = `http://line.me/ti/g/mtTCUtAEe_`;
    Swal.fire({
      title: "Link Group",
      html:
      '<br>' +
      'Jika sudah melakukan pendaftaran silahkan bergabung pada link grup berikut' + '<br><br>' +
        '<p class:"m-auto" style:"font-weight: 300"> <a style="color: #5b4f81;" href="' + url + '" target="_blank">http://line.me/ti/g/IEjAyqhdtd</a></p>', 
      animation: true
    });
  });
