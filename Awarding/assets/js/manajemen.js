...
function fetchNominies() {
    ...
    axios.get(BASEURL + 'vote/vote/nomini/bfbbcfa7-f26c-4deb-b78e-78316c2ee614')
        .then(({ data }) => {
            nominies = data.data
            renderNominies(nominies)
        })
...
function renderNominies(nominies) {
    ...
    var filteredNominies = nominies.filter(nomini => {
        return nomini.description == 'TOP5_BEM_Manajemen Internal'
    })
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      .then(res => {
                        ...
                        if(`${res.data.message}` == 'kamu sudah melakukan voting TOP5_BEM_Manajemen Internal'){
                          Swal.fire(
                            'Maaf!',
                            `${res.data.message}`,
                            'error'
                        ...
                        }if(`${res.data.message}` == 'voting TOP5_BEM_Manajemen Internal telah ditutup pada 2020-11-21 09:59:00'){
                          Swal.fire(
                            'Maaf!',
                            `${res.data.message}`,
                            'error'
