...
function fetchNominies() {
    ...
    axios.get(BASEURL + 'vote/vote/nomini/36c84dee-bde4-4349-bce4-0e5186aa83ae')
        .then(({ data }) => {
            nominies = data.data
            renderNominies(nominies)
        })
...
function renderNominies(nominies) {
    ...
    var filteredNominies = nominies.filter(nomini => {
        return nomini.description == 'TOP5_DPM_Kinerja Teroptimal'
    })
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      .then(res => {
                        ...
                        if(`${res.data.message}` == 'kamu sudah melakukan voting TOP5_DPM_Kinerja Teroptimal'){
                          Swal.fire(
                            'Maaf!',
                            `${res.data.message}`,
                            'error'
                        ...
                        }if(`${res.data.message}` == 'voting TOP5_DPM_Kinerja Teroptimal telah ditutup pada 2020-11-21 09:59:00'){
                          Swal.fire(
                            'Maaf!',
                            `${res.data.message}`,
                            'error'
