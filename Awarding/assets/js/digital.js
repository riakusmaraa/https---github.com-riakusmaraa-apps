...
function fetchNominies() {
    ...
    //     })
    axios.get(BASEURL + 'vote/vote/nomini/a502730a-1b2c-4433-8491-2b888f83adf9')
        .then(({ data }) => {
            nominies = data.data
            renderNominies(nominies)
        })
...
function renderNominies(nominies) {
    ...
    var filteredNominies = nominies.filter(nomini => {
        return nomini.description == 'TOP5_BEM_Sistem Kerja Digital'
    })
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(res => {
                          ...
                          if(`${res.data.message}` == 'kamu sudah melakukan voting TOP5_BEM_Sistem Kerja Digital'){
                            Swal.fire(
                              'Maaf!',
                              `${res.data.message}`,
                              'error'
                          ...
                          }if(`${res.data.message}` == 'voting TOP5_BEM_Sistem Kerja Digital telah ditutup pada 2020-11-21 09:59:00'){
                            Swal.fire(
                              'Maaf!',
                              `${res.data.message}`,
                              'error'
