...
function fetchNominies() {
  ...
  //     })
  axios.get(BASEURL + 'vote/vote/nomini/3c539f01-ba63-4114-9d4e-aef1fa4fb49b')
      .then(({ data }) => {
          nominies = data.data
          renderNominies(nominies)
      })
...
function renderNominies(nominies) {
  ...
  var filteredNominies = nominies.filter(nomini => {
      return nomini.description == 'TOP5_BEM_Proker Andalan'
  })
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    .then(res => {
                      ...
                      if(`${res.data.message}` == 'kamu sudah melakukan voting TOP5_BEM_Proker Andalan'){
                        Swal.fire(
                          'Maaf!',
                          `${res.data.message}`,
                          'error'
                      ...
                      }if(`${res.data.message}` == 'voting TOP5_BEM_Proker Andalan telah ditutup pada 2020-11-21 09:59:00'){
                        Swal.fire(
                          'Maaf!',
                          `${res.data.message}`,
                          'error'
