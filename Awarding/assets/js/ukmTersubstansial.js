...
function fetchNominies() {
    ...
    //     })
    axios.get(BASEURL + 'vote/vote/nomini/fcfc1bdb-d630-4425-8aad-57a6b54d5643')
        .then(({ data }) => {
            nominies = data.data
            renderNominies(nominies)
        })
...
function renderNominies(nominies) {
    ...
    var filteredNominies = nominies.filter(nomini => {
        return nomini.description == 'TOP5_UKM_Tersubstansial'
    })
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      .then(res => {
                        ...
                        if(`${res.data.message}` == 'kamu sudah melakukan voting TOP5_UKM_Tersubstansial'){
                          Swal.fire(
                            'Maaf!',
                            `${res.data.message}`,
                            'error'
                        ...
                        }if(`${res.data.message}` == 'voting TOP5_UKM_Tersubstansial telah ditutup pada 2020-11-21 09:59:00'){
                          Swal.fire(
                            'Maaf!',
                            `${res.data.message}`,
                            'error'
