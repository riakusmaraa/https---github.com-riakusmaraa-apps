      ...
      $.ajax({
        ...
        success: r => {
          if (r.error) {
            ...
            $(".menu-wrap").html(
              '<div class="row justify-content-center"><div class="col-md-4"><div class="bancard cyan-primary"><h5 class="mb-3 font-weight-bold">Badan Eksekutif Mahasiswa</h5><img src="img/bem.svg" alt="" />' +
                bemStatus +
                '</div></div><div class="col-md-4"><div class="bancard green-primary"><h5 class="mb-3 font-weight-bold">Dewan Perwakilan Mahasiswa</h5><img src="img/dpm.svg" alt="" />' +
                dpmStatus +
                '</div></div></div><div class="row justify-content-center"><div class="col-md-4"><div class="bancard orange-primary"><h5 class="mb-3 font-weight-bold">Unit Kegiatan Mahasiswa</h5><img src="img/ukm.svg" alt="" />' +
                ukmStatus +
                '</div></div><div class="col-md-4"><div class="bancard purple-primary"><h5 class="mb-3 font-weight-bold">Chairman</h5><img src="img/chairman.svg" alt="" />' +
                chairmanStatus +
                "</div></div></div>"
            );
          }
