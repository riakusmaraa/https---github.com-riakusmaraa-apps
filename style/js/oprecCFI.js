      ...
      $.ajax({
        ...
        .done(function() {
          ...
          if (dafresponse.DAFTAR != null) {
            ...
            $("#guide").text("Apabila ada hal-hal yang kurang jelas silahkan hubungi CP : Rizky Kurniawan (081291112252) atau Dzikri  (081932362303)");
    ...
    $("#formulir").on("click", function() {
      ...
      Swal.fire({
        ...
        html:
          ...
          "<br><br>" +
          '<p class:"m-auto" style:"font-weight: 300">Seluruh form dikirim ke firdhan16@gmail.com dengan format Namalengkap_CFI</p>',
        animation: true
      });
    });
    ...
    $("#formulir").on("click", function() {
      ...
      Swal.fire({
        ...
        html:
          ...
          '"><button type="button" class="prokerbtn form2">Form 2</button></a>' +
          "<br><br>" +
          '<p class:"m-auto" style:"font-weight: 300">Seluruh form dikirim ke firdhan16@gmail.com format Namalengkap_CFI</p>',
        animation: true
      });
    });
