$(document).ready(function() {
    ...
    function popupResult(result) {
        ...
        if (result.src) {
            html =
                ...
                result.src +
                '" />' +
                '<p class="font-weight-bold mb-2">Apabila tombol download tidak bisa, silahkan tekan lama pada gambar lalu bagikan post melalui instagram atau download<a href="./img/twibbonbmc.png"> di sini</a></p><a href="' +
                result.src +
                '" id="downloadlink" class="button" download="twibbonbmc.png">Download</a>' +
    ...
    $("#downloadlink").on("click", ".sweet-alert", function() {
        console.log(this);
        downloadCanvas(this, "imageCanvas", "twibbonbmc.png");
    });
