...
<p >[FORM 1/3] JADWAL INTERVIEW : ';$html.=date('d F Y',strtotime(cetak("JADWAL"))).'</p>

<barcode code=';$html.=$nim; $html.=' type="C128A" class="barcode" size="1.2" error="M" disableborder="1" />
...
$html.='</td>
<td rowspan="4" width="120px" ><img src="http://siakad.ub.ac.id/siam/biodata.fotobynim.php?nim=';$html.=$nim.'&key=MzIxZm90b3V5ZTEyMysyMDE4LTA4LTIxIDIxOjA2OjAw" alt=""></td>
